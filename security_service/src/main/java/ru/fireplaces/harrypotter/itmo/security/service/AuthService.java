...
public interface AuthService {
     ...
     * @return ID of created {@link ru.fireplaces.harrypotter.itmo.security.domain.model.User}
     ...
     *
     * @param request Login and password
     * @return {@link ru.fireplaces.harrypotter.itmo.security.domain.model.User} ID and
